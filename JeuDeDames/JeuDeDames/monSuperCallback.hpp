...
public:
    void operator()(osg::Node* noeud, osg::NodeVisitor* visiteur){
        ...
        osg::Vec4d restest = osg::Vec4d(0,0,-r/10,0);
        
        osg::Vec4d normale = mt->getMatrix()*restest;
        osg::Vec4d resultante = normale - restest;
        ...
        osg::Vec3d pos = osg::Vec3d(resultante.x(),resultante.y(),0) + posPrev;
